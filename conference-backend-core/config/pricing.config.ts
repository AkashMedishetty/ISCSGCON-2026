  ...
  earlyBird: {
    ...
    categories: {
      'iscsg-member': {
        ...
        amount: 4000,
        currency: 'INR',
        description: 'For registered ISCSG members'
      },
      'consultant': {
        key: 'consultant',
        ...
        amount: 5000,
        currency: 'INR',
        description: 'For consultants and practicing clinicians'
      },
      'postgraduate': {
        key: 'postgraduate',
        label: 'Postgraduate',
        amount: 2500,
        currency: 'INR',
        description: 'For postgraduate students'
      },
      'international': {
        key: 'international',
...
export const workshops: Workshop[] = [
  {
    id: 'orthobiologics-live',
    name: 'Live Orthobiologics Workshop',
    description: 'Live demonstration of biologics and regenerative medicine techniques at Nizam Institute of Medical Sciences Hyderabad',
    amount: 3500,
    currency: 'INR',
    maxSeats: 50,
    instructor: 'Dr. Lalith Mohan C & Faculty',
    duration: 'Full Day (March 14, 2026)'
  },
  {
    id: 'prp-therapy',
    name: 'PRP Therapy Masterclass',
    description: 'Platelet-Rich Plasma preparation and application techniques',
    amount: 2500,
    currency: 'INR',
    maxSeats: 40,
  ...
  {
    id: 'stem-cell-harvesting',
    name: 'Stem Cell Harvesting Techniques',
    description: 'Hands-on training in stem cell harvesting and processing',
    amount: 3000,
    currency: 'INR',
    maxSeats: 30,
    instructor: 'Expert Faculty',
  ...
  {
    id: 'cartilage-regeneration',
    name: 'Cartilage Regeneration Workshop',
    description: 'Advanced techniques in cartilage repair and regeneration',
    amount: 2500,
    currency: 'INR',
    maxSeats: 35,
    instructor: 'Expert Faculty',
...
export const discountCodes: DiscountCode[] = [
  {
    ...
    type: 'percentage',
    value: 10,
    description: 'ISCSG member special discount',
    validFrom: '2025-06-01',
    validTo: '2026-03-10',
    isActive: true,
    maxUses: 200,
    applicableCategories: ['iscsg-member']
  },
  {
    code: 'EARLYBIRD2026',
    type: 'percentage',
