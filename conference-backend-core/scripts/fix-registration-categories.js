// Script to fix registration_categories config for ISCSGCON 2026
...
async function fixRegistrationCategories() {
  try {
    ...
    if (!registrationConfig) {
      ...
      // Update to ISCSGCON 2026 categories
      ...
      console.log('✅ Updated registration_categories for ISCSGCON 2026');
