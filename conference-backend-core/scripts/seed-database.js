...
/**
 * Comprehensive Database Seeding Script for ISCSGCON 2026
  ...
  const sampleUsers = [
    {
      ...
      payment: {
        ...
        verifiedBy: 'admin@iscsgcon2026hyderabad.com',
...
async function seedDatabase() {
  try {
    ...
    console.log('   ✅ Proper ISCSG registration types (postgraduate, consultant)')
