...
async function fixEmailConfiguration() {
  ...
  if (currentConfig) {
    ...
    const updatedConfig = {
      ...
      fromEmail: process.env.SMTP_USER || 'info@iscsgcon2026hyderabad.com',
      replyTo: process.env.SMTP_USER || 'info@iscsgcon2026hyderabad.com'
    };
    ...
    const newEmailConfig = {
      ...
      templates: {
        registration: {
          enabled: true,
          subject: 'Application Received - ISCSGCON 2026'
        },
        payment: {
          enabled: true,
          subject: 'Payment Confirmation - ISCSGCON 2026'
        },
        reminder: {
          enabled: true,
          subject: 'Payment Reminder - ISCSGCON 2026'
        },
        bulkEmail: {
          enabled: true,
